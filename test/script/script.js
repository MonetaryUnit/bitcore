...
describe('Script', function() {
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      var address = Address.fromString('79mT5x8vxu8PCCbr6X9HPBk7q7Z6EJYXec');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0x4974db369ae9c322a0b12369a8dc1ff9e929d329 OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress().toString().should.equal('79mT5x8vxu8PCCbr6X9HPBk7q7Z6EJYXec');
    });
  ...
  describe('#buildPublicKeyOut', function() {
    it('should create script from public key', function() {
      ...
      should.exist(s);
      s.toString().should.equal('33 0x02ca62331055111846544ea6be4bcf74ac3a018dfc6aeb27188879e2cfe9b6bc23 OP_CHECKSIG');
  ...
  describe('#buildScriptHashOut', function() {
    ...
    it('inherits network property from other script', function() {
      var s1 = new Script.fromAddress(new Address('79mT5x8vxu8PCCbr6X9HPBk7q7Z6EJYXec'));
    ...
    it('inherits network property form an address', function() {
      var address = new Address('4oN9sxJVbBJKvKNGuZNptRcbHYJBfV8M28');
  ...
  describe('getData returns associated data', function() {
    ...
    it('for a P2SH address', function() {
      var address = Address.fromString('4oN9sxJVbBJKvKNGuZNptRcbHYJBfV8M28');
  ...
  describe('toAddress', function() {
    ...
    it('for a P2PKH address', function() {
      var stringAddress = '79mT5x8vxu8PCCbr6X9HPBk7q7Z6EJYXec';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    it('for a P2SH address', function() {
      var stringAddress = '4oN9sxJVbBJKvKNGuZNptRcbHYJBfV8M28';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    ...
    it('works for p2pkh output', function() {
      ...
      script.toAddress().toString().should.equal('7MPCacXutz5kHPBe91gUZTtEfqpBySYyre');
    });
    it('works for p2pkh input', function() {
      ...
      s2.toAddress().toString().should.equal('79ZDd9Zb4w3rMrbAyUUM5R2WXwZvwnGBQT');
    });
    ...
    it('works for p2sh output', function() {
      ...
      script.toAddress().toString().should.equal('4s4mVZ53SP8XmzdeVnXzrVwQK8E1eGYFMu');
    });
    it('works for p2sh input', function() {
      ...
      script.toAddress().toString().should.equal('4su8Yq9MmbBRs3KuTrWvTFHC8Mw36qSgMa');
    });
