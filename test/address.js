...
describe('Address', function() {
  ...
  var pubkeyhash = new Buffer('4974db369ae9c322a0b12369a8dc1ff9e929d329', 'hex');
  var buf = Buffer.concat([new Buffer([0]), pubkeyhash]);
  var str = '7JEWePSjKVaXmk4FJ9NSfwXXiT7sePSHgY';
  ...
  // livenet valid
  var PKHLivenet = [
    '74crAAm9Kno4dCJmsDpYZSkwnPjDLp3J3i',
    '7GeC4yY5g3RGjDesT6nb2nCmswMBjqFPGc',
    '73Zx39F6NhACp8aT1tXNvSKTebSLCxZUFY',
    '75iB8WcKHyue6ShGVXf7xHY7fDRcYmZWzs',
    '    74AcCzuDW6Lt7uLynUpSwFCvSRsNMSRvji   \t\n'
  ];

  // livenet p2sh
  var P2SHLivenet = [
    '4ervXKLvyM1DDJjnbsQzykXSdihpGXU5PZ',
    '4kxoE8WFRTfbfRzNEEEPaQsCxrp82y9vbX',
    '4fHv6jjTHCHhCu1NyVMwFcGzhP6qzXADiY',
    '4vnMGM5etcxHRFFC155gEG5yW3w4aF8CtJ',
    '\t \n 4vnMGM5etcxHRFFC155gEG5yW3w4aF8CtJ \r'
  ];
  ...
  describe('validation', function() {
    ...
    it('getValidationError detects network mismatchs', function() {
      var error = Address.getValidationError('4xVMEBghsLWoWCBFHRj6QF8tw89Xu74gXJ', 'testnet');
      should.exist(error);
    });

    it('isValid returns true on a valid address', function() {
      var valid = Address.isValid('4xVMEBghsLWoWCBFHRj6QF8tw89Xu74gXJ', 'livenet');
      valid.should.equal(true);
    });

    it('isValid returns false on network mismatch', function() {
      var valid = Address.isValid('4xVMEBghsLWoWCBFHRj6QF8tw89Xu74gXJ', 'testnet');
    ...
    it('addresses with whitespace are validated correctly', function() {
      var ws = '  \r \t    \n 7CAxeeMqSBn9hjVdj94gA6mpWWUjyLZKLK \t \n            \r';
      var error = Address.getValidationError(ws);
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('7CAxeeMqSBn9hjVdj94gA6mpWWUjyLZKLK');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      var pubkey = new PublicKey('02ca62331055111846544ea6be4bcf74ac3a018dfc6aeb27188879e2cfe9b6bc23');
      var address = Address.fromPublicKey(pubkey, 'livenet');
      address.toString().should.equal('79mT5x8vxu8PCCbr6X9HPBk7q7Z6EJYXec');
    });

    it('should use the default network for pubkey', function() {
      var pubkey = new PublicKey('0296abb6e89fddefc5fa78aef1c55fd0a7b42a312bc7f9a63735be009942a69a13');
      var address = Address.fromPublicKey(pubkey);
      address.network.should.equal(Networks.defaultNetwork);
    });

    it('should make this address from an uncompressed pubkey', function() {
      var pubkey = new PublicKey('ca62331055111846544ea6be4bcf74ac3a018dfc6aeb27188879e2cfe9b6bc23' +
        '9326406041d5fc69d5a8c8c00bbbd12ba457100c12ebd8579825e885e7a62790');
      var a = Address.fromPublicKey(pubkey, 'livenet');
      a.toString().should.equal('79mT5x8vxu8PCCbr6X9HPBk7q7Z6EJYXec');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('79mT5x8vxu8PCCbr6X9HPBk7q7Z6EJYXec');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('7MPCacXutz5kHPBe91gUZTtEfqpBySYyre');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('7MPCacXutz5kHPBe91gUZTtEfqpBySYyre');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('4tG4JDJ1kEMAgBvQczWYB6HjnMyCHe5MQ5');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('4tG4JDJ1kEMAgBvQczWYB6HjnMyCHe5MQ5');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = '7MPCacXutz5kHPBe91gUZTtEfqpBySYyre';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = '4tG4JDJ1kEMAgBvQczWYB6HjnMyCHe5MQ5';
  ...
  describe('#toBuffer', function() {
    ...
    it('a654108ceb49f5cff1e38d6abdc689eb94f17342 corresponds to hash 7JEWePSjKVaXmk4FJ9NSfwXXiT7sePSHgY', function() {
      var address = new Address(str);
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: 7JEWePSjKVaXmk4FJ9NSfwXXiT7sePSHgY, type: pubkeyhash, network: livenet>';
  ...
  it('will use the default network for an object', function() {
    var obj = {
      hash: 'd551561980d7f9166022b048710dbd251e03be23',
      type: 'scripthash'
    };
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('4sFFKrv1Y7nMvrKqa86FdUeDzvpwRCzcEV');
