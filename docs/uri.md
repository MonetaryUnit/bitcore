...
URI Examples:
```
monetaryunit:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu
monetaryunit:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2
monetaryunit:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2&message=Payment&label=Satoshi&extra=other-param
```
...
```javascript
var uriString = 'monetaryunit:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2';
