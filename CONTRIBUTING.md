...
```sh
git remote add bitpay git@github.com:MonetaryUnit/bitcore.git
...
```
Finally go to [github.com/MonetaryUnit/bitcore](https://github.com/MonetaryUnit/bitcore) in your web browser and issue a new pull request.
...
[github.com/MonetaryUnit/bitcore/issues](https://github.com/MonetaryUnit/bitcore/issues).
